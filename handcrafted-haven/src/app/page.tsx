                    ...
                    <section className={styles.testimonials}>
                        ...
                        <div className={styles.testimonialGrid}>
                            <div className={styles.testimonialCard}>
                                <p>"I love my handcrafted items from Handcrafted Haven! They add a unique touch to my home."</p>
                                <h4>- Emily R.</h4>
                            </div>
                            <div className={styles.testimonialCard}>
                                <p>"The quality and creativity of the artisans are truly inspiring. I always find something special!"</p>
                                <h4>- John M.</h4>
                            </div>
                            <div className={styles.testimonialCard}>
                                <p>"Shopping here makes me feel good, knowing I'm supporting local talent!"</p>
                                <h4>- Sarah K.</h4>
                            </div>
                            <div className={styles.testimonialCard}>
